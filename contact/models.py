...
class Contact(models.Model):
    ...
    body_height = models.IntegerField(
        validators=[MaxValueValidator(250)], null=True, blank=True
    )
    body_weight = models.IntegerField(
        validators=[MaxValueValidator(500)], null=True, blank=True
    )
    board_length = models.IntegerField(
        validators=[MaxValueValidator(20)], null=True, blank=True
    )
    board_volume = models.IntegerField(
